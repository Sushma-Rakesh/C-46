class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      ...
      { x: width / 2 + 100, y: height - 3300, image: obstacle2Image },
...
showRank() {
  swal({
    ...
    imageUrl:
      "https://previews.123rf.com/images/quartadis/quartadis1610/quartadis161000004/66619578-vector-trophy-champion-cup-flat-icon-champion-cup-winner-trophy-award-and-victory-prize-champion-cup.jpg",
    imageSize: "100x100",
